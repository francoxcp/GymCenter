    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Data usage section
          _buildSectionTitle(
              l10n.isEn ? 'Data Usage' : 'Uso de Datos'),
          _buildSwitchTile(
          ...
          _buildSwitchTile(
            title: l10n.isEn ? 'Workout Insights' : 'Análisis de Entrenamientos',
            subtitle: l10n.isEn
            ...
            onChanged: (v) => setState(() => _workoutInsights = v),
          ),
          const SizedBox(height: 24),

          // Your data section
          _buildSectionTitle(
              l10n.isEn ? 'Your Data' : 'Tus Datos'),
          _buildInfoTile(
